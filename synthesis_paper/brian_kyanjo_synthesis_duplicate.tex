...
%	A fundamental set of equations is the Riemann so
	...
	The flux difference $ f(Q_i) - f(Q_{i-1})$ is directly decomposed as  a linear combination of the eigenvectors $r_{i-\frac{1}{2}}$ as shown in equation \eqref{fw} \cite{barzgaran2019numerical}
